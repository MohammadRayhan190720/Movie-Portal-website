...
const Faq = () => {
  return (
    <div className="mt-10 lg:mt-16 bg-background max-w-7xl mx-auto">
      ...
      <div className="mt-6 lg:mt-10 space-y-3">
        <div className="collapse collapse-plus bg-[#272727] hover:bg-[#3F3F3F] ">
          ...
          <div className="collapse-content">
            <p className="text-xl text-justify">
              ...
              movie exploration. It allows users to browse movies, view detailed
              information, manage favorites, and stay updated with the latest
              releases, creating a seamless and enjoyable cinematic experience.
              <br></br>
              CineVerse is your ultimate destination for movie lovers, offering
              personalized recommendations, interactive features, user reviews,
              and a vibrant community to enhance your movie journey. Discover,
              explore, and immerse yourself in the world of cinema effortlessly
              with CineVerse
            </p>
        ...
        <div className="collapse collapse-plus bg-[#272727] hover:bg-[#3F3F3F] ">
          ...
          <div className="collapse-content">
            <p className="text-xl text-justify">
              ...
              nothing to cancel. Simply stop using the platform anytime without
              any obligations or fees—your experience is entirely hassle-free!
            </p>
        ...
        <div className="collapse collapse-plus bg-[#272727] hover:bg-[#3F3F3F] ">
          ...
          <div className="collapse-content">
            <p className="text-xl text-justify">
              CineVerse is suitable for all ages, including kids, as it features
              movies from various genres. However, parents are encouraged to
              review movie ratings and descriptions to ensure content aligns
              with their children’s preferences and age appropriateness.
            </p>
